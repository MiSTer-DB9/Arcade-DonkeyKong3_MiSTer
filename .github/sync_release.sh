...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-DonkeyKong3_MiSTer.git"
CORE_NAME=(Arcade-DonkeyKong3)
...
UPSTREAM_CORE_NAME=(Arcade-DonkeyKong3)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-DonkeyKong3.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-DonkeyKong3.rbf)
